...
/*   Updated: 2024/05/20 13:21:20 by kiroussa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
sStT\000\001\002\003\004\005\006\a\b\016\017\020\021\022\023\024\025\026\027\030\
...
int	msh_strcoll(t_minishell *msh, char *s1, char *s2)
{
	...
	locale = msh_env_get(msh, "LC_COLLATE");
	if (!locale)
		locale = "C";
