...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   msh_ast_merge_pattow.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: kiroussa <oss@xtrm.me>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/17 22:05:30 by kiroussa          #+#    #+#             */
/*   Updated: 2024/10/07 00:28:18 by kiroussa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_ast_token	*msh_ast_merge_pattow_create(
	t_list *token,
				...
				t_ast_token *first, t_ast_token *second)
{
	...
	msh_log(msh, MSG_DEBUG_EXEC_TRANSFORMER, "running merge_pattow\n");
	...
	next = msh_ast_merge_pattow_create(token, first, second, string);
	msh_log(msh, MSG_DEBUG_EXEC_TRANSFORMER, "merge_pattow success\n");
	return (next);
}
